  ...
  <div>
    <nav>
      <div class="nav__content">
        <div class="logo"><i><a>INSEMTIF</a></i></div>
        <label for="check" class="checkbox">
          <i class="ri-menu-line"></i>
        </label>
        <input type="checkbox" name="check" id="check" />
        <ul>
          <li><router-link to="/dashboard">Dashbord</router-link></li>
          ...
          <tbody id="table-body">
            <tr v-for="(mahasiswa, index) in mahasiswas" :key="index">
              ...
              <td>
                ...
                <button><router-link to="/inputnilaita" class="btn btn-kelola">kelola</router-link></button>
              </td>
            </tr>
          </tbody>
        </table>
